...
module OctocatalogDiff
  ...
  class Config
    ...
    def self.config
      ...
      settings[:hiera_config] = 'octocatalog-diff/hiera.yaml' # Relative path, assumes hiera.yaml at top of repo
      ...
      settings[:puppetdb_ssl_ca] = 'ca.pem'
      ...
      settings[:puppetdb_ssl_client_key]  = File.read("puppetdb.key.pem")
      settings[:puppetdb_ssl_client_cert] = File.read("puppetdb.pem")
